...
public static class WorldDataHelper
{
    public static Vector3Int ChunkPositionFromBlockCoords(World world, Vector3Int position)
    {
        ...
        {
            //converting players position to the position of the chunk they are in
            //this means that the returned values only increment by 16, as that is the chunk size
